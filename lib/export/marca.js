 ...
 *
 *   `nitia`      → null: el exportador usa su paleta tal cual.
 ...
 * tablas con el navy de Nitia dentro del documento de otra institución es
 * justo lo que el docente quiso evitar al subir el suyo.
 *
 * Antes esto devolvía `null` para plantilla, que significa «la paleta de
 * Nitia». El resultado: tablas azul marino y barras de momento de SciVerse
