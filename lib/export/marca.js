...
export function explicarModo(marca, opciones = {}) {
  ...
  if (efectivo === guardado) {
    return {
      ...
      // El alcance va EN la frase, no sólo en la tarjeta: decir «tus
      // documentos» a secas contradice lo que pasa al descargar un STEAM.
      plantilla: "Tus sesiones y clases completas usan tu plantilla .docx; el resto de documentos usan el formato de tu colegio.",
    }[efectivo];
  }
