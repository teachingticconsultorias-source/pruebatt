...
/** El aviso concreto para un marcador que no se puede sustituir. */
export function explicarMarcadorRoto(clave) {
  return `La marca {{${clave}}} no se pudo reconocer. Bórrala y vuelve a escribirla a mano, sin copiarla con formato: Word a veces la parte en trozos y deja de detectarse.`;
}
