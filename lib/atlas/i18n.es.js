...
export const T = {
  ...
  /* -------------------------------------------------------------- CONTROLES */
  // Dos acciones distintas, porque son dos intenciones distintas. Antes un
  // solo «Restablecer» hacía las dos y volvía a encender la piel cada vez que
  // alguien quería recuperar el encuadre.
  restablecer: "Restablecer vista",
  restaurarVisibilidad: "Restaurar visibilidad",
