-- ============================================================
-- SciVerse — Recursos complementarios de una sesión
-- Incluye/asegura:
--   • 5 generaciones IA semanales
--   • Ficha de aprendizaje
--   • Rúbrica
--   • Lista de cotejo
--   • Escala de valoración
--   • Guardado en "Mis creaciones"
--
-- Ejecutar UNA VEZ en Supabase > SQL Editor.
-- Es compatible con la migración freemium anterior.
-- ============================================================
...
-- ---------- MIS CREACIONES ----------
-- La tabla actual de SciVerse limita los tipos.
-- La ampliamos sin eliminar registros existentes.
...
-- Las políticas RLS existentes siguen funcionando porque dependen de user_id,
-- no del tipo de material.
