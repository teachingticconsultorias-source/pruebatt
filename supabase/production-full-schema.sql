...
\restrict oG3Ts0VvKBiplHsXH5mJkhtnaBaCVcViqibkMDrepUD2Q0wl2vnouBfoavzuc1t
...
--
-- Name: users al_crear_usuario; Type: TRIGGER; Schema: auth; Owner: -
--

CREATE TRIGGER al_crear_usuario AFTER INSERT ON auth.users FOR EACH ROW EXECUTE FUNCTION public.crear_perfil_docente();
...
--
-- Name: FUNCTION crear_perfil_docente(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.crear_perfil_docente() TO anon;
GRANT ALL ON FUNCTION public.crear_perfil_docente() TO authenticated;
GRANT ALL ON FUNCTION public.crear_perfil_docente() TO service_role;
...
--
-- Name: TABLE materiales_docente; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.materiales_docente TO anon;
GRANT ALL ON TABLE public.materiales_docente TO authenticated;
GRANT ALL ON TABLE public.materiales_docente TO service_role;
...
\unrestrict oG3Ts0VvKBiplHsXH5mJkhtnaBaCVcViqibkMDrepUD2Q0wl2vnouBfoavzuc1t
