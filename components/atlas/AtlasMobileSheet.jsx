...
/* ==========================================================================
   ...
   ------------------------------
   Porque el encargo pide poder seguir moviendo el modelo con la ficha
   abierta, y un modal lo impide por definición: bloquea todo lo de detrás.
   Aquí no hay velo. La hoja ocupa la parte baja, el modelo sigue arriba y se
   puede girar mientras se lee.

   De ahí también que NO lleve `aria-modal` ni atrape el foco: mentiría sobre
   su comportamiento a quien use lector de pantalla. Escape la cierra, el
   foco entra al abrir y vuelve al lienzo al cerrar, que es lo que
   corresponde a un panel no modal.
