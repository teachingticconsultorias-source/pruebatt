    ...
    <div style={{ background: C.bg, color: C.text, minHeight: "100vh", fontFamily: "'Inter', sans-serif" }} className="flex items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-md rounded-2xl p-7" style={{ background: C.surface, border: `1px solid ${C.line}` }}>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 rounded-lg py-2.5 mb-2 text-sm font-semibold"
          style={{ background: "#fff", color: "#1f1f1f", border: `1px solid ${C.line}` }}
        >
          <span className="w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold" style={{ background: "#4285F4", color: "#fff" }}>G</span>
          Continuar con Google
        </button>
        {googleNote && (
          <p className="text-xs mb-4" style={{ color: C.muted }}>
            El inicio con Google requiere configurarse en un entorno de producción. Por ahora, regístrate con el formulario de abajo.
          </p>
        )}

        <div className="flex items-center gap-2 my-4">
          <div className="h-px flex-1" style={{ background: C.line }} />
          <span className="text-xs" style={{ color: C.muted }}>o con tus datos</span>
          <div className="h-px flex-1" style={{ background: C.line }} />
        </div>
